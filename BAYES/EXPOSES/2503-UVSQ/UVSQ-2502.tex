...
\frame{\frametitle{Latent variable models in ecology}
  ...
  \begin{itemize}
    ...
    \item encode dependency (due to space, parental relatedness, ...), 
...
%====================================================================
\frame{\frametitle{Variational EM (VEM) algorithm (1/2)}
...
%====================================================================
\frame{\frametitle{Variational EM (VEM) algorithm (2/2)}

...
\centerline{
  \begin{tabular}{c}
    \begin{tabular}{lr}
      ...
      &
      \begin{tabular}{c}
        \epsfig{file = ../Figures/DRD03-Fig4.ps, height=8cm, width=8cm, bbllx=225,
          bblly=553, bburx=410, bbury=705, clip=}
      \end{tabular}
    \end{tabular}
    \\
    \begin{tabular}{c}
      \epsfig{file = ../Figures/DRD03-Fig6.ps, height=10cm, width=24cm, bbllx=125,
        bblly=510, bburx=544, bbury=694, clip=}
    \end{tabular}
  \end{tabular}
}
...
\begin{tabular}{cc}
  ...
  \begin{tabular}{c}
    \begin{pspicture}(12, 18)
      ...
      \epsfig{file = ../Figures/DRD03-Fig5.ps, height=18cm, width=12cm, bbllx=135,
        bblly=235, bburx=490, bbury=660, clip=}
    \end{pspicture}        
  \end{tabular}
\end{tabular}
...
\begin{tabular}{ll}
  ...
  \\
  \textblue{$f$:} & the  (alternative) density $f$ \\
\end{tabular}
$$

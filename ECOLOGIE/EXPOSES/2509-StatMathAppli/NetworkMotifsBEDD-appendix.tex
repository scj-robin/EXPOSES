%==================================================================
\frame{\frametitle{Network embedding: Zackenberg's data \refer{SRO16}} \label{back:motifPCA}

  \bigskip
  \begin{tabular}{c|c|c|c}
    \onslide+<1->{Raw counts} & 
    \onslide+<2->{Normalized counts} & 
    \onslide+<3->{Choleski} & 
...
\frame{\frametitle{In practice: Asymptotic normality} \label{back:asymNormality}
  ...
  \bigskip
  \textcolor{blue}{Normal} distribution, \textcolor{magenta}{Poisson-geometric} distribution with same mean and variance \refer{Sta01,PDK08} \goto{sec:motifMoments} \goto{sec:discussion}

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\paragraph{Scale free distribution of the degree.} 
...
\begin{tabular}{cc}
  ...
  \begin{tabular}{c}
    ...
    \epsfig{file = ../Figures/Barabasi4.ps, clip=, bbllx=0, bblly=130,
      bburx=595, bbury=688, width=18cm, height=14cm}
  \end{tabular}
\end{tabular}

\noindent These descriptions characterise the graph but \textblue{do
  not provide a model} for it.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\chapter{Uncovering Structure in Networks} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{tabular} \\
Similar to the block structure model ({\sl Novicki \& Snijders, 01})
%$$
...
\begin{tabular}{cc}
  \begin{tabular}{p{15cm}}
    \subsection{\sl Shen-Orr \& al, Nat. Genet., 02:} \\
    \\
    ...
    \paragraph{Strategy.} 
    \begin{enumerate}
    \item Count the number of occurrences $N_{\mbf}(G)$; 
    \item Resample a \textblue{large number of random networks}
      similar to {\sl E.coli}'s one (e.g. same degree for each gene);
    \item Estimate $\Esp N_{\mbf}(G)$ and $\Var N_{\mbf}(G)$;
    \item Calculate a $Z$-score: $Z = (N_{\mbf}(G) - \Esp
      N_{\mbf}(G))/ \sqrt{\Var N_{\mbf}(G)}$;
...
%    & $\overline{\pi}$ & 5 & 5 & 5 & 5 & 5 & 1 & 1 & 1 & 1 & 1 \\
    (\%) & $\alpha$ & 10 & 10 & 50 & 50 & 50 & 10 & 10 & 50 & 50 & 50 \\
    ...
    & $1/(1-a)$ & 1.9 & 1.2 & 1.2 & 1.1 & 1.3 & 2.0 & 1.2 & 1.2 & 1.1 & 1.2 \\
...
%     & $\widehat{F}_P$ & 0.9 & 0.3 & 0.5 & 0.9 & 0.5 & 0.9 & 0.5 & 1.2 & 1.6 & 0.7 \\
    ...
    &  $1/(1-a)$ & 10.0 & 3.6 & 3.0 & 3.1 & 3.3 & 50.0 & 12.5 & 10.0 & 10.0 & 10.0 \\
...
\item \vspace{-0.5cm} Define the exact distribution of the clump size:
  connected to the size of connected component in a random graph.
\end{itemize}

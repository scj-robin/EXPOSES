...
\frame{\frametitle{Properties of the \BEDD model}
  ...
  \begin{itemize}
    ...
    \item or, equivalently, star (single edge, top, bottom) frequencies (see next)
  \end{itemize}
...
\frame{\frametitle{Goodness-of-fit (GOF) of the BEDD model}
  ...
  \begin{tabular}{lc}
    \hspace{-.05\textwidth}
    \begin{tabular}{p{.5\textwidth}}
      \onslide+<2->{\paragraph{Raw statistic:}
      $$
...
%==================================================================
%==================================================================
\section{Contrast-based network embedding}
\frame{\frametitle{Outline} \tableofcontents[currentsection]}%==================================================================
\frame{\frametitle{Understanding the organisation of plant-pollinator networks}

  On-going joint work with Natasha de Manincor (Mons, Belgiuem) \& Fran\c{c}ois Massol (soon in IEES, SU)
...
\frame{\frametitle{Contrast-based network embedding}
  ...
  \begin{enumerate}
    \setlength{\itemsep}{1.05\baselineskip}
    \item The distance $d$ focuses on the difference in terms of pollinator imbalance
    \item (Hopefully) insensitive to other factors: networks' dimensions ($m, n$), connectance ($\rho$), plant imbalance ($h$), \dots
  \end{enumerate}
...
\begin{frame}[fragile] \frametitle{Yes but}
  ...
  \begin{itemize}
    ...
    \item Same network-specif connectances $(\rho_kk)$ as in the original dataset,

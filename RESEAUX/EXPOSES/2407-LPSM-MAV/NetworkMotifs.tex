...
\frame{\frametitle{Comparing network imbalances}
  ...
  \begin{itemize}
    ...
    H_0 = \{g^A = g^B\}
    $$
    \item For motif $s$, evaluate $\widehat{\Esp}_{\widehat{\rho}^A, \emphase{\widehat{g}^B}, \widehat{h}^A}(N^A_s)$ and $\widehat{\Esp}_{\widehat{\rho}^B, \emphase{\widehat{g}^A}, \widehat{h}^B}(N^B_s)$ and compare 
    $$
...
\begin{frame}[fragile] \frametitle{Results}
  ...
  \paragraph{Distance-based analysis of variance.} \refer{LeA99,McA01}
  \begin{itemize}

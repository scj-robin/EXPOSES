...
\newcommand{\fignoisynetsimul}{/home/robin/Bureau/Souhila/NoisyNetworkInference/Figs}
...
%   \paragraph{Remarks.} \\ ~
  \begin{enumerate}    
    ...
    \end{itemize} ~ \\
    \item Parametric distribution for the scores (e.g. Gaussian), ... or not \\ ~
...
%==================================================================
\frame{\frametitle{Score distributions $F_0$ and $F_1$}

  \paragraph{Univariate Gaussian.} For $u = 0, 1$
  $$
  (S_{ij} \mid G_{ij} = u) \sim \Ncal(\mu_u, \sigma_u^2)
  $$
  
  \pause \bigskip \bigskip
  \paragraph{Multivariate Gaussian.} Deal with deveral scores: $S_{ij} = (S_{ij}^a, S_{ij}^b, S_{ij}^c)$
  $$
  (S_{ij} \mid G_{ij} = u) \sim \Ncal(\mu_u, \Sigma_u)
  $$
  
  \pause \bigskip \bigskip
  \paragraph{Non parametric.} 
  $$
  \widehat{f}_u(s) = \sum_{ij} w_{ij}^u \kappa\left(\frac{s - s_{ij}}{h}\right)
  $$
  \begin{itemize}
   \item $\kappa =$ (possibly multivariate) kernel function with bandwidth $h$
   \item Updates for the weights $w_{ij}^u$ given in \refer{GCR16}
  \end{itemize}
...
\frame{\frametitle{Simulation study}
  ...
  \begin{itemize}
   ...
   \item Gaussian data $Y \sim \Ncal_p(0, \Omega_G^{-1})$ (\emphase{How to build $\Omega_G$?})
   \item Sample size $n = 20, 50, 100, 200$
   \item Edge scores from Meinshausen-B\"uhlmann (\textcolor{red}{MB}) and \textcolor{green}{tree-base} algorithms
  \end{itemize}
  ...
  \onslide<2>
    ...
    $\begin{array}{cccc}
    p = 20 & p = 30 & p = 50 & p = 80 \\
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-ARIvem-p20} & 
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-ARIvem-p30} &
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-ARIvem-p50} &
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-ARIvem-p80}
    \end{array}$
  \onslide<3>
  ...
  $\begin{array}{cccc}
    p = 20 & p = 30 & p = 50 & p = 80 \\
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-AUCvem-p20} & 
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-AUCvem-p30} &
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-AUCvem-p50} &
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-AUCvem-p80}
  \end{array}$
  \end{overprint}
...
%==================================================================
\frame{\frametitle{Node classification (ARI)}

  \paragraph{Proposed VEM.} 
  $$
  \begin{array}{cccc}
    p = 20 & p = 30 & p = 50 & p = 80 \\
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-ARIvem-p20} & 
  ...
  \paragraph{SBM on true $G$ or thresholded scores.} 
  $$
  \begin{array}{cccc}
    p = 20 & p = 30 & p = 50 & p = 80 \\
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-ARIoracle-p20} & 
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-ARIoracle-p30} &
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-ARIoracle-p50} &
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-ARIoracle-p80}
  \end{array}
  $$
  Scores = \textcolor{red}{MB}, \textcolor{green}{tree-base}, \textcolor{blue}{MB-Tree}, \textcolor{cyan}{np:MB-Tree}, $n = 20, 50, 100, 200$

}

%==================================================================
\frame{\frametitle{Edge recovery (AUC)}
  ...
  \paragraph{Gaussian SBM on the scores.} 
  $$
  \begin{array}{cccc}
    p = 20 & p = 30 & p = 50 & p = 80 \\
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-AUCoracle-p20} & 
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-AUCoracle-p30} &
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-AUCoracle-p50} &
    \includegraphics[width=.22\textwidth]{\fignoisynetsimul/simVEM-Ktrue3-g2-Cneg-K3-AUCoracle-p80}
  \end{array}
  $$
  Scores = \textcolor{red}{MB}, \textcolor{green}{tree-base}, \textcolor{blue}{MB-Tree}, \textcolor{cyan}{np:MB-Tree}, $n = 20, 50, 100, 200$
...
\frame{\frametitle{Discussion} \label{sl:discus}
  ...
  \begin{itemize}
   ...
   \item Model identifiability for non-parametric score distribution \goto{sl:scoreDist}
  \end{itemize}

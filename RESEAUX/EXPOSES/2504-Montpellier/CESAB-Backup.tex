...
%==================================================================
\frame{\frametitle{Asymptotic distribution of the count \label{back:motifDistrib}}
  ...
  $$
  \textcolor{gray}{(back to \#\ref{sec:motifMoments})}
...
%==================================================================
\frame{\frametitle{Choleski transform \label{back:cholevsky}}
  ...
  \begin{tabular}{cc}
    ...
    \begin{tabular}{p{.45\textwidth}}
      ...
      \Sigma_{X'_1, X'_2} = \left[\begin{array}{cc} 
                     ...
                     \end{array}\right]
      $$
      \textcolor{gray}{(back to \#\ref{sec:cholevsky})}
      }
    \end{tabular} 
  \end{tabular}
...
%==================================================================
\frame{\frametitle{Results for other motif distances}
...
%==================================================================
\frame{\frametitle{Null simulations}

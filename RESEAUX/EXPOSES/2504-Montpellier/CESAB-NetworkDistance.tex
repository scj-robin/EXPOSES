\newcommand{\fignatasha}{/home/robin/RECHERCHE/RESEAUX/GOF-Network/Motif_Analysis_Natasha/Figures}
\newcommand{\tabnatasha}{./Tables}
...
%       $$
      \includegraphics[width=.45\textwidth, trim=0 10 20 50, clip=]{\fignatasha/All_NatashaBinNetList-stat3-distMat}
%       $$
    \end{tabular} 
  \end{tabular}
...
\frame{\frametitle{Result}
  ...
  \begin{tabular}{l|rrrrr}
    \input{\tabnatasha/All_NatashaBinNetList-stat1-adonis-perm99999-adonis2}
  \end{tabular}
  }$$

...
%==================================================================
\frame{\frametitle{Result \label{sec:adonisResults}}
  ...
  \begin{itemize}
    \setlength{\itemsep}{1.15\baselineskip}
    \item \pause Because of small network sizes, need to correct for it \textcolor{gray}{(see \#\ref{back:adonisNull})}
    ...
    \item \pause No effect is found for the plant imbalance distance $D^{(h)}$ \textcolor{gray}{(see \#\ref{back:adonisOther})}
  \end{itemize}

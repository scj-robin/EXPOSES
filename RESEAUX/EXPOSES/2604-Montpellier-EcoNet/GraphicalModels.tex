...
\frame{ \frametitle{Statistical model}
  ...
  $$
  Y_i \sim p \quad \text{= joint distribution: } p(y_1, \dots, y_j, \dots, y_m)
  $$
...
\frame{\frametitle{Graphical models} 
  ...
  need for a probabilistic counterpart for this concept
...
\frame{\frametitle{A simple (interesting) example}
  ...
  \begin{itemize}
   \item $p(a, b, c, \dots)$ is not enough to retrieve the edge orientations

...
image.plot(1:d, 1:m, plnFull$model_par$B[-1, order(cluster)], main='clustering species', xlab='covariates', ylab='species')
...
abiotics = cbind(plnDiag = as.vector(plnDiag$model_par$B[-1, ]), 

  ...
  \draw[edge] (Z1) to (Y12);  \draw[edge] (Z2) to (Y12);
  \draw[edge] (Z1) to (Y13);  \draw[edge] (Z3) to (Y13);
  \draw[edge] (Z1) to (Y14);  \draw[edge] (Z4) to (Y14);
  \draw[edge] (Z2) to (Y23);  \draw[edge] (Z3) to (Y23);
  \draw[edge] (Z2) to (Y24);  \draw[edge] (Z4) to (Y24);
  \draw[edge] (Z3) to (Y34);  \draw[edge] (Z4) to (Y34);

...
%====================================================================
\section[Few loci, few patients]{Few loci, few patients: small $n$, small $p$}
\frame{\frametitle{Few loci, few patients: small $n$, small $p$}}
...
%====================================================================
\section[Many loci, few patients]{Many loci, few patients: large $n$, small $p$}
\frame{\frametitle{Many loci, few patients: large $n$, small $p$}}
...
%====================================================================
\section[Many loci, many patients]{Many loci, many patients: large $n$, large $p$}
\frame{\frametitle{Many loci, many patients: large $n$, large $p$}}
...
\paragraph{Proposition.} Denoting $\tau = \lambda + \mu$, $\theta = \lambda/\tau$, $\sigma^2 = \theta(1-\theta)$,
$$
...
\frame{\frametitle{New problem}
  ...
  Denote $V_{OU}(\widetilde{m})$ the longest excursion
%   \footnote{Of meanders and excursion: isn't it bucolic?} 
  of an $OU(\tau)$ above threshold $\widetilde{m}$:
  $$

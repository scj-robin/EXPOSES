...
\end{eqnarray*}
under the constraint $\sum_{m=1}^MK_m=K$.
...
\begin{figure}
\begin{tabular}{cc}
\includegraphics[scale=0.20]{Segmentation_F_patients_3_C6.png}&
\includegraphics[scale=0.20]{Segmentation_F_patients_9_C6.png}
\end{tabular}
\end{figure}
...
\begin{center}
\includegraphics[scale=0.36]{effetfixesimul.png}
\end{center}
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{tabular}{cc}
\includegraphics[scale=0.19]{patientsansclassif19.png}&
\includegraphics[scale=0.19]{patient19simul.png}
\end{tabular}
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\caption{1 Segmented profil}
\begin{tabular}{cc}
\includegraphics[scale=0.19]{patientsansclassif6.png}&
\includegraphics[scale=0.19]{pat6simul.png}
\end{tabular}
\end{figure}

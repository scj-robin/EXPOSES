...
\frame{\frametitle{'Motivation'} 
  ...
  \onslide+<5>{\paragraph{Modelling.} Markov switching process.}
}
...
%     \includegraphics[width=1\textwidth, height=.8\textheight]{\figsimul/SimHHMM1DV8-tol6-T1-Q3-Coef-compAIC}
    ...
    \includegraphics[width=.6\textwidth, height=.8\textheight]{\figsimul/SimHHMM1DV8-tol6-T1-Q3-Coef-diag}
  \end{overprint}
}
...
\frame{ \frametitle{Example}
  ...
  \begin{tabular}{ccc}
    ...
    ~ \\
    \includegraphics[width=0.3\textwidth, trim=10 40 20 50, clip=]{\figchiro/Chiro-seq1776-N1048-Qmax5-classif-seg} &
    \qquad & 
    \includegraphics[width=0.3\textwidth, trim=10 40 20 50, clip=]{\figchiro/Chiro-seq1776-N1048-Qmax5-classifP-seg} 
  \end{tabular}
  $$
  \begin{itemize}
...
%     \includegraphics[width=1\textwidth, height=.8\textheight]{\figsimul/SimHHMM1DV8-tol6-T1-Q2-Coef-compAIC}
    \onslide<4> \paragraph{Classification.} MAP / Viterbi (+ comput. time) \\
    \includegraphics[width=.6\textwidth, height=.8\textheight]{\figsimul/SimHHMM1DV8-tol6-T1-Q2-Coef-diag}
  \end{overprint}
}

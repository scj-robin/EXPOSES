...
\frame{\frametitle{A reminder on Bayesian inference} 
  ...
  $$
  Y \sim p(\cdot; \vartheta)
  $$

  \pause \bigskip
  \paragraph{'Classical' or 'frequentist' framework:} $\vartheta$ supposed to be fix.
  \begin{itemize}
   \item Try to provide a estimate $\widehat{\vartheta}$ not too far from the true $\vartheta^*$.
  \end{itemize}

  \pause \bigskip \bigskip
  \paragraph{Bayesian framework:} $\vartheta$ is random with  \emphase{\sl prior} distribution $p(\vartheta)$.
  \begin{itemize}
   \item Try to establish its conditional distribution given the data: 
   $$
   p(\vartheta|Y) = \frac{p(\vartheta) p(Y|\vartheta)}{p(Y)}
...
\frame{\frametitle{Illustration: Beta binomial (2/2)}
  ...
  \begin{tabular}{cc}
    ...
    \begin{tabular}{p{.5\textwidth}}
      \begin{overprint}
       \onslide<2>\includegraphics[width=.5\textwidth]{../FIGURES/Fig-BetaBinom-Prior1}
       \onslide<3>\includegraphics[width=.5\textwidth]{../FIGURES/Fig-BetaBinom-Prior1-Data}
       \onslide<4>\includegraphics[width=.5\textwidth]{../FIGURES/Fig-BetaBinom-Prior1-Data-Posterior1}
       \onslide<5>\includegraphics[width=.5\textwidth]{../FIGURES/Fig-BetaBinom-Prior1-Data-ConfInter1}
       \onslide<6>\includegraphics[width=.5\textwidth]{../FIGURES/Fig-BetaBinom-Prior2}
       \onslide<7>\includegraphics[width=.5\textwidth]{../FIGURES/Fig-BetaBinom-Prior2-Data-Posterior2}
      \end{overprint}
    \end{tabular}
  \end{tabular}
...
\frame{\frametitle{Bayesian inference} 
  ...
  \begin{align*}
   ...
   \text{likelihood:} & \quad p(Y|\vartheta) \qquad \text{(given by the model)}\\
  ...
  $$
  p(\vartheta|Y) = {p(\vartheta) p(Y|\vartheta)} \ / \ {p(Y)}
  $$
  is often not trivial, typically because
  $$
  p(Y) = \int_\Theta p(Y|\vartheta) p(\vartheta) \dd \vartheta
  $$
...
\frame{\frametitle{Posterior distribution} 
  ...
  \begin{enumerate}
   ...
   $$
   \text{sample} \quad (\vartheta^b) \sim p(\vartheta | Y).
   $$ \\~ 
   \item \pause {Approximation} (e.g. Variational Bayes, Expectation propagation, ...): 
   $$
   \text{find} \qquad q_Y(\vartheta) \simeq p(\vartheta | Y).
   $$ \\~ 
   \item \pause {Exact:} 
   $$
   \text{actually compute} \qquad p(\vartheta|Y)
   $$
...
\frame{\frametitle{Models with discrete parameters}
  ...
  \paragraph{Mixed parameter:} $ \vartheta \rightarrow (\theta, T)$
  $$
...
\frame{\frametitle{Main issue}
  ...
  Suppose that the calculation wrt $\theta$ raise no issue\footnote{Using e.g. conjugate priors.}, the calculation of 
  $$
  \sum_{T \in \Tcal}
  $$
...
\frame{\frametitle{Change-point in a graphical model} 
  ...
  \end{itemize}
  $$
  \includegraphics[height=.3\textheight]{../FIGURES/ChangePoint-Tree.pdf}
  $$
...
\frame{\frametitle{Some simulations} 
  ...
  \begin{tabular}{ccc}
   ...
   \begin{tabular}{c}
    \includegraphics[width=.3\textwidth]{../FIGURES/ScR16-Fig4-Tree_N_p10_Tree}
   \end{tabular}
   &
   \hspace{-.05\textwidth}
   \begin{tabular}{c}
    \includegraphics[width=.3\textwidth]{../FIGURES/ScR16-Fig4-ER2p_N_p10_Tree}
   \end{tabular}
   &
   \hspace{-.05\textwidth}
   \begin{tabular}{c}
    \includegraphics[width=.3\textwidth]{../FIGURES/ScR16-Fig4-ER4p_N_p10_Tree}
   \end{tabular}
   \\
   \begin{tabular}{c}
    \includegraphics[width=.3\textwidth]{../FIGURES/ScR16-Fig4-Tree_N_p10_Complete}
   \end{tabular}
   &
   \hspace{-.05\textwidth}
   \begin{tabular}{c}
    \includegraphics[width=.3\textwidth]{../FIGURES/ScR16-Fig4-ER2p_N_p10_Complete}
   \end{tabular}
   &
   \hspace{-.05\textwidth}
   \begin{tabular}{c}
    \includegraphics[width=.3\textwidth]{../FIGURES/ScR16-Fig4-ER4p_N_p10_Complete}
   \end{tabular}
  \end{tabular}
...
\frame{\frametitle{Gene regulatory network} 
  ...
  $$
  \includegraphics[width=.7\textwidth]{../FIGURES/SrS16-Fig8-chgpt_EMP_ap10_au1}
  $$

  \pause
  Inferred networks:
  $$
  \includegraphics[width=.8\textwidth]{../FIGURES/SrS16-Fig9-network_seuil02}
  $$

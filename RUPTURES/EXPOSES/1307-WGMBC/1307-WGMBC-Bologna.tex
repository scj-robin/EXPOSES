...
\newcommand{\figPopova}{/home/robin/Bureau/LOH/Data/Popova}
\renewcommand{\chr}{11}
...
\renewcommand{\figname}{R_BLC_B1_T45-Chr11} \renewcommand{\figres}{R_BLC_B1_T45-Chr11-c3-5-Gam}
...
%  \pause \bigskip \bigskip
  \paragraph{Corollary of the previous Theorem \refer{GCR13}.} The proposed HMM for CNV/LOH analysis is identifiable as soon as the emission distributions $f_z$ are linearly independent.
...
%====================================================================
\section*{Conclusion}
\frame{\frametitle{Identifiability in HMMs}
  ...
  \bigskip \bigskip \pause
  \paragraph{But raises a series issues} in terms of
  \begin{itemize}

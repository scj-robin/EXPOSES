...
\institute[AgroParisTech / INRA]{
 ...
 \begin{tabular}{ccccc}
  ...
  \date[Amsterdam, 2014]{\footnotesize{Seminar at the  Vrije Universiteit / VU medical center, Amsterdam, 28-Mar-2014}}
...
\frame{\frametitle{Two scales} 
  ...
  \begin{itemize}
   ...
   \ra Pruned Exact Linear Time (PELT) \refer{KFE12}, Pruned Dynamic Programing Algorithm (PDPA) \refer{Rig10}
   \item Need for a dedicated criterion to choose $K$: \\
...
$$
\begin{array}{lccccc}
{\bf K} = (5, 5, 5) & \tau_1 & \tau_2 & \tau_3 & \tau_4 \\ 
\hline \\
